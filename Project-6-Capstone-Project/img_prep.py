...
model.fit_generator(datagen.flow(X_train_fin, y_train_fin, batch_size=32),
                    samples_per_epoch=len(X_train_fin), nb_epoch=1, validation_data=(X_val, y_val))
loss_and_metrics = model.evaluate_generator(X_val, y_val, batch_size=32)
